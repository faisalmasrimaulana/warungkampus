...
@php
    $base = 'inline-flex items-center px-4 py-2 rounded-md text-sm font-semibold transition';
        ...
        'secondary' => 'bg-white text-blue-600 shadow-lg hover:shadow-xl hover:cursor-pointer hover:text-white px-8 py-3',  
        ...
        'danger' => 'bg-red-600 text-white hover:cursor-pointer hover:bg-white hover:text-red-700 px-8 py-3',
