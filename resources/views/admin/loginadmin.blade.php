...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen">
        <div class="flex flex-col items-center justify-center min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            ...
            <!-- FORM LOGIN -->
            <x-formcard action="{{route('admin.login.submit')}}" method="POST">
                <!-- INPUT -->
                <div class="space-y-4">
                    <x-input label="Admin Id" name="admin_id" placeholder="Masukkan Admin Id" :autofocus="true" autocomplete="username"/>

                    <x-input label="Password" name="password" placeholder="Masukkan Password" type="password" autocomplete="current-password"/>
                </div>
